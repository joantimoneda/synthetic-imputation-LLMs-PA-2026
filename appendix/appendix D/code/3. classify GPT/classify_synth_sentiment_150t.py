...
## Classify sentiment for 150/50 sample
...
true150 = pd.read_excel("../../data/true_samples/true_150_sample.xlsx", index_col=0)
true150.rename(columns={"tweet":"text"}, inplace=True)
true150["sentiment"] = true150["sentiment"].str.lower()
true150 = true150[["text", "sentiment", "label"]]
true150["synthetic"] = 0
true150

# Read in synthetic data
synth = pd.read_excel("../../data/synthetic/synthetic_150t_50.xlsx", index_col=0) # use 
synth["sentiment"] = "positive"
synth["label"] = 1
synth

# Combine both sets
data = pd.concat([true150, synth], axis=0)
...
all_synth.to_excel("../../data/classified/classified_full_150t_50.xlsx")
