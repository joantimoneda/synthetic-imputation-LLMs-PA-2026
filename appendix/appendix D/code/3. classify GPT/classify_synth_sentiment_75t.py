...
## Classify sentiment for 75/125 sample
...
true75 = pd.read_excel("../../data/true_samples/true_75_sample.xlsx", index_col=0)
true75.rename(columns={"tweet":"text"}, inplace=True)
true75["sentiment"] = true75["sentiment"].str.lower()
true75 = true75[["text", "sentiment", "label"]]
true75["synthetic"] = 0
true75

# Read in synthetic data
synth = pd.read_excel("../../data/synthetic/synthetic_75t_125.xlsx", index_col=0) # use 
synth["sentiment"] = "positive"
synth["label"] = 1
synth

# Combine both sets
data = pd.concat([true75, synth], axis=0)
...
all_synth.to_excel("../../data/classified/classified_full_75t_125.xlsx")
