...
## Classify sentiment for 100/100 sample
...
true100 = pd.read_excel("../../data/true_samples/true_100_sample.xlsx", index_col=0)
true100.rename(columns={"tweet":"text"}, inplace=True)
true100["sentiment"] = true100["sentiment"].str.lower()
true100 = true100[["text", "sentiment", "label"]]
true100["synthetic"] = 0
true100

# Read in synthetic data
synth = pd.read_excel("../../data/synthetic/synthetic_100t_100.xlsx", index_col=0) # use 
synth["sentiment"] = "positive"
synth["label"] = 1
synth

# Combine both sets
data = pd.concat([true100, synth], axis=0)
...
#Examples
neg = data[(data["label"] == 0) & (data["synthetic"]==0)].sample(5, random_state=10)
pos = data[(data["label"] == 1) & (data["synthetic"]==0)].sample(5, random_state=10)
...
all_synth.to_excel("../../data/classified/classified_full_100t_100.xlsx")
