...
## Classify sentiment for 50/150 sample
...
true50 = pd.read_excel("../../data/true_samples/true_50_sample.xlsx", index_col=0)
true50.rename(columns={"tweet":"text"}, inplace=True)
true50["sentiment"] = true50["sentiment"].str.lower()
true50 = true50[["text", "sentiment", "label"]]
true50["synthetic"] = 0
true50

# Read in synthetic data
synth = pd.read_excel("../../data/synthetic/synthetic_50t_150.xlsx", index_col=0) # use 
synth["sentiment"] = "positive"
synth["label"] = 1
synth

# Combine both sets
data = pd.concat([true50, synth], axis=0)
...
all_synth.to_excel("../../data/classified/classified_full_50t_150.xlsx")
