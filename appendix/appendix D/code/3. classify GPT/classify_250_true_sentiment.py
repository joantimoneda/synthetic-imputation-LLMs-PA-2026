...
## Classify sentiment for 250 true
...
data = pd.read_excel("true_250_sample.xlsx", index_col=0) # use 
...
all_synth.to_excel("data/classified/classified_full_250_true.xlsx")
