...
## Generate synth for 75 true samples
...
# Get the data
d = pd.read_excel("true_75_sample.xlsx", index_col=0)
...
exp.to_excel("data/synthetic/synthetic_75t_125.xlsx")
