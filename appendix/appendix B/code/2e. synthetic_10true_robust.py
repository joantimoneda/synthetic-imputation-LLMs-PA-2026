...
exp.to_excel("data synthetic/synthetic_10_141.xlsx")


# combine datasets

synth = pd.read_excel("data synthetic/synthetic_10_141.xlsx", index_col=0) # if not in memory
...
final_data.to_excel("data synthetic/synthetic_10_141_fullsample.xlsx")

final_data_reloaded = pd.read_excel("data synthetic/synthetic_10_141_fullsample.xlsx", index_col=0)
