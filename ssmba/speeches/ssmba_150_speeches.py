...
## Data: 
import pandas as pd
data = pd.read_excel("../../../speeches_intl/data samples/intl_speeches_sample_150.xlsx", index_col=0)
...
with open('txt_150_speeches.txt', 'w') as f:
    for entry in text:
        f.write(entry + " \n ")
...
parser.add_argument('-i', '--in-file', type=str, default='txt_150_speeches.txt',
...
parser.add_argument('-o', '--output-prefix', type=str, default='out_150_speeches',)
...
with open('out_150_speeches', 'r') as f:
        output = f.readlines()
...
synthetic = pd.Series([0]*150 + [1]*68)
...
combined.to_excel("ssmba_150_speeches.xlsx")
...
combined_final.to_excel("ssmba_150_full_speeches.xlsx")
