...
## Data: 
import pandas as pd
data = pd.read_excel("../../../speeches_intl/data samples/intl_speeches_sample_75.xlsx", index_col=0)
...
with open('txt_75_speeches.txt', 'w') as f:
    for entry in text:
        f.write(entry + " \n ")
...
parser.add_argument('-i', '--in-file', type=str, default='txt_75_speeches.txt',
...
parser.add_argument('-o', '--output-prefix', type=str, default='out_75_speeches',)
...
with open('out_75_speeches', 'r') as f:
        output = f.readlines()
...
synthetic = pd.Series([0]*75 + [1]*143)
...
combined.to_excel("ssmba_75_speeches.xlsx")
...
combined_final.to_excel("ssmba_75_full_speeches.xlsx")
