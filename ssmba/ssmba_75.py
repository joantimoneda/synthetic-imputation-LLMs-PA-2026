...
## Data: 
import pandas as pd
data = pd.read_excel("../../nostalgia/data samples/fake_nost_75.xlsx", index_col=0)

text = data.loc[:,"text"]
text = [x+"\n" for x in text]

with open('txt_75_nost.txt', 'w') as f:
    for entry in text:
        f.write(entry + " \n ")
...
parser.add_argument('-i', '--in-file', type=str, default='txt_75_nost.txt',
...
parser.add_argument('-o', '--output-prefix', type=str, default='out_75',)
...
combined_final.to_excel("ssmba_75_76_full.xlsx")
