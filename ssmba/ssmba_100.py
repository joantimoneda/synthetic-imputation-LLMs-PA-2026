...
## Data: 
import pandas as pd
data = pd.read_excel("../../nostalgia/data samples/fake_nost_100.xlsx", index_col=0)

text = data.loc[:,"text"]
text = [x+"\n" for x in text]

with open('txt_100_nost.txt', 'w') as f:
    for entry in text:
        f.write(entry + " \n ")
...
parser.add_argument('-i', '--in-file', type=str, default='txt_100_nost.txt',
...
parser.add_argument('-o', '--output-prefix', type=str, default='out_100',)
...
combined_final.to_excel("ssmba_100_51_full.xlsx")
