...
synth_new = pd.read_excel("synthetic_75_143.xlsx", index_col=0) 
...
real50 = pd.read_excel("../../data samples/intl_speeches_sample_75.xlsx", index_col=0) # use 
real50 = real50[["text_eng", "speechtype", "label"]]
real50.rename(columns={"text_eng": "text"}, inplace=True)
real50["label"] = 1
real50["synthetic"] = 0

# Put final data together to classify
data = pd.concat([synth_new, other_cats, real50]).reset_index(drop=True)
...
all_synth.to_excel("GPT_synthetic_labeled_75_143.xlsx")
